...
//Function that handles the styling when resizing windows
function handleWindowResize(){
    switch(activeCorner){
        case "top-left":
            if(window.innerWidth <= 1100){  //for mobile
        ...
        case "bottom-left":
            ...
            }else if(window.innerWidth <= 1100){ //for desktop
                blActive = "translateX(0) translateY(0)";
                blContent.style.transform = "translateX(0vw) translateY(0)";
                blContent.style.width = "100vw";
                blContent.style.height = "100vh";
...
//Store the last reversed animation, ready to be played
